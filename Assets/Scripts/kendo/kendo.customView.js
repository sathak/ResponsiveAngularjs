...
(function ($, undefined) {
    ...
    //extend UI
    extend(true, ui, { SchedulerTimelineYearView: SchedulerTimelineYearView });
})(window.kendo.jQuery);
...
(function ($, undefined) {
    var kendo = window.kendo,
        ui = kendo.ui,
        CustomAgendaView = ui.AgendaView,
        extend = $.extend,
        NS = ".kendoCustomAgendaView";

    var CustomAgendaView = kendo.ui.AgendaView.extend({
        nextDate: function () {
    ...
    //extend UI
    extend(true, ui, { CustomAgendaView: CustomAgendaView });
})(window.kendo.jQuery);
...
(function ($, undefined) {
    ...
    //extend UI
    extend(true, ui, { ToDoView: ToDoView });
})(window.kendo.jQuery);